  ...
  def update 
   ...
   private
    ...
    def ouvrages_revue_params
      params.require(:ouvrages_revue).permit(:date, :delai_commentaire, :delai_action, :delai_time,:delai_indicateur, :budget_indicateur, :budget_commentaire, :date_maj, :budget_action, :ouvrage_id)
    end
end